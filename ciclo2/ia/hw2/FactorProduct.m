...
% usar prueba1 para el A y B (segun el ejm de la diapo)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
assigA = IndexToAssignment(indxA, [A.card]);
assigB = IndexToAssignment(indxB, [B.card]);

pA = GetValueOfAssignment(A, assigA);
pB = GetValueOfAssignment(B, assigB);
